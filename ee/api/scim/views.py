...
class SCIMUsersView(SCIMBaseView):
    def get(self, request: Request, domain_id: str) -> Response:
        ...
        return Response(
            _build_scim_list_response(
                queryset, pagination=pagination, adapter_cls=PostHogSCIMUser, organization_domain=organization_domain
            )
        )
...
class SCIMGroupsView(SCIMBaseView):
    def get(self, request: Request, domain_id: str) -> Response:
        ...
        return Response(
            _build_scim_list_response(
                queryset, pagination=pagination, adapter_cls=PostHogSCIMGroup, organization_domain=organization_domain
            )
        )
