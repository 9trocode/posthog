...
`flags_geoip_properties_not_applied_total` counts requests where at least one resolved GeoIP property was skipped because the caller had already supplied it.
