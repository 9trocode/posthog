...
async def _spawn_and_run(
    *,
    ...
    session, result = await MultiTurnSession.start(
        ...
        # Selection is per scout: of the creator's grants, only the servers picked on this
        # config mount. Empty selects none. Teammates' team-scoped shares are not gated here.
